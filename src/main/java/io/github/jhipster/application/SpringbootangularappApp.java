...
public class SpringbootangularappApp {

    private static final Logger log = LoggerFactory.getLogger(SpringbootangularappApp.class);

    private final Environment env;

    public SpringbootangularappApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Springbootangularapp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SpringbootangularappApp.class);
